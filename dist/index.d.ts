...
export declare function createElement<Props, Element extends HTMLElement | VirtualElement>(type: keyof HTMLElementTagNameMap | {
    new (element: null, props: Props): VirtualElement;
}, props: Attributes | Props, ...children: Child[]): Element;
